This folder contains results, scripts and data used for the scripts for dataset AG News.
...
Datasets collected from ChatGPT (news_gpt_{method}.csv)
Seed data used (news_seeeds_*.csv)
NLPAug data collected (news_{nlpaug_method}.csv)
LLama3 data collected (news_paraphrases_train_{method}_w_tryout.csv)

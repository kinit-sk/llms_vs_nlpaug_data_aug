...
methods = ['para', 'swap', 'ins'] #['para', 'swap', 'ins', 
...
for method in methods: 
    ...
    train_file = 'ag_news/data/news_paraphrases_train_'+method+'_w_tryout.csv'
    ...
    for no_seed_samples in lst_no_seeds_samples:
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'ag_news/results/bert_lora'+dct_seeds_to_inc[args.seed]+'/news_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_llm.csv'

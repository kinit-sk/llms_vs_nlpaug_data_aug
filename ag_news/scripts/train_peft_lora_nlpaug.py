...
for method in methods: 
    ...
    train_file = 'ag_news/data/news_'+method+'.csv'
    ...
    for no_seed_samples in lst_no_seeds_samples:
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'ag_news/results/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/news_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

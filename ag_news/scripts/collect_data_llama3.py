...
for phase in ['train']:
    get_subsampled = pd.read_csv('ag_news/data/news_seeds_'+phase+'.csv')
    ...
    with open('ag_news/data/news_paraphrases_'+phase+'_para_w_tryout.pkl', 'wb') as handle:
...
for phase in ['train']:
    ...
    with open('ag_news/data/news_paraphrases_'+phase+'_ins_w_tryout.pkl', 'wb') as handle:
        pickle.dump(dct_responses, handle)
...
for phase in ['train']:
    ...
    with open('ag_news/data/news_paraphrases_'+phase+'_swap_w_tryout.pkl', 'wb') as handle:
        pickle.dump(dct_responses, handle)

...
# commented part for using GPT-3.5 data for finetuning
...
for no_seed_samples in lst_no_seeds_samples:
    for method in methods: 
        ...
        for repeat_no in range(0, args.repeat):
            ...
            df_orig_sub['text'] = df_orig_sub['text'].str.lower()
        ...
        res_file = 'news_category/results/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/news_'+method+'_seeds_'+str(no_seed_samples)+'.csv'

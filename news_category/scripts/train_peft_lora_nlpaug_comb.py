...
methods = ['cont_ins', 'back'] # we combine these two methods
lst_no_seeds_samples = [30, 40, 50, 100]
...
for no_seed_samples in lst_no_seeds_samples:
    ...
    train_file0 = 'news_category/data/news_'+methods[0]+'.csv'
    train_file1 = 'news_category/data/news_'+methods[1]+'.csv'
    ...
    for no_coll_samples in lst_no_coll_samples:
        ...
        res_file = 'news_category/results/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/news_comb_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

...
for method in methods: 
    ...
    train_file = 'fb/data/fb_'+method+'.csv'
    ...
    for no_seed_samples in lst_no_seeds_samples:
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'fb/results/distilbert_lora'+dct_seeds_to_inc[args.seed]+'/fb_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

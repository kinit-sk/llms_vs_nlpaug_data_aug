This folder contains results, scripts and data used for the scripts for dataset fb.
...
Datasets collected from ChatGPT (fb_gpt_{method}.csv)
Seed data used (fb_seeeds_*.csv)
NLPAug data collected (fb_{nlpaug_method}.csv)
LLama3 data collected (fb_paraphrases_train_{method}_w_tryout.csv)

...
for no_seed_samples in lst_no_seeds_samples:
    for method in methods: 
        ...
        train_file = 'sst5/data/sst_paraphrases_train_'+method+'_w_tryout.csv'
        ...
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'sst5/data/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/sst_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_llm.csv'

...
for no_seed_samples in lst_no_seeds_samples:
    for method in methods: 
        ...
        train_file = 'sst5/data/sst_'+method+'.csv'
        ...
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'sst5/results/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/sst_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

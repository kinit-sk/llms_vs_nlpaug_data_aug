...
for phase in ['train']:
    get_subsampled = pd.read_csv('sst5/data/sst_seeds_'+phase+'_1.csv')
    ...
    with open('sst5/data/sst_paraphrases_'+phase+'_para_w_tryout_1.pkl', 'wb') as handle:
...
for phase in ['train']:
    ...
    with open('sst5/data/sst_paraphrases_'+phase+'_ins_w_tryout_1.pkl', 'wb') as handle:
        pickle.dump(dct_responses, handle)
...
for phase in ['train']:
    ...
    with open('sst5/data/sst_paraphrases_'+phase+'_swap_w_tryout_1.pkl', 'wb') as handle:
        pickle.dump(dct_responses, handle)

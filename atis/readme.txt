This folder contains results, scripts and data used for the scripts for dataset Atis.
...
Datasets collected from ChatGPT (atis_gpt_{method}.csv)
Seed data used (atis_seeeds_*.csv)
NLPAug data collected (atis_{nlpaug_method}.csv)
LLama3 data collected (atis_paraphrases_train_{method}_w_tryout.csv)

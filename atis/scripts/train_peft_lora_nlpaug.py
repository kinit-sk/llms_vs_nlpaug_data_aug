...
for method in methods: 
    ...
    train_file = 'atis/data/atis_'+method+'.csv'
    ...
    for no_seed_samples in lst_no_seeds_samples:
        for no_coll_samples in lst_no_coll_samples:
            ...
            for repeat_no in range(0, args.repeat):
                ...
                df_train = pd.concat(dfs).sample(frac=1, random_state=args.seed).reset_index(drop=True).drop_duplicates().dropna()
            ...
            res_file = 'atis/results/distilbert_lora'+dct_seeds_to_inc[args.seed]+'/atis_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

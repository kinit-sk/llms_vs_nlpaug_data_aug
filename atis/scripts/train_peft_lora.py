...
for method in methods: 
    ...
    train_file = 'atis/data/atis_paraphrases_train_'+method+'_w_tryout.csv'
    ...
    for no_seed_samples in lst_no_seeds_samples:
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'atis/results/distilbert_lora'+dct_seeds_to_inc[args.seed]+'/atis_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_llm.csv'

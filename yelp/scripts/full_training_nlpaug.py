...
df_orig = pd.read_csv('yelp/aug_data/csv/yelp_seeds_train.csv').sample(frac=1, random_state=args.seed).reset_index(drop=True).drop_duplicates().dropna()
...
for no_seed_samples in lst_no_seeds_samples:
    for method in methods: 
        ...
        train_file = 'yelp/aug_data/csv/yelp_'+method+'.csv'
        ...
        for no_coll_samples in lst_no_coll_samples:
            ...
            res_file = 'yelp/data/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/yelp_'+method+'_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

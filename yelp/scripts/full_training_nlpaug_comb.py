...
for no_seed_samples in lst_no_seeds_samples:
    ...
    for no_coll_samples in lst_no_coll_samples:
        ...
        res_file = 'yelp/aug_data/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/yelp_comb_seeds_'+str(no_seed_samples)+'_coll_'+str(no_coll_samples)+'_class.csv'

...
def get_samples_per_seed(df_orig, no_seeds):
    ...
    return df_orig_sub.rename(columns={'seed': 'text'})
...
methods = ['clean'] #['w2v', 'cont', 'cont_ins',
...
for no_seed_samples in lst_no_seeds_samples:
    for method in methods: 
        ...
        for repeat_no in range(0, args.repeat):
            ...
            df_orig_sub = get_samples_per_seed(df_orig, no_seed_samples)
            df_train = df_orig_sub
        ...
        res_file = 'yelp/results/'+dct_model_to_dir[args.base_model_type]+''+dct_seeds_to_inc[args.seed]+'/yelp_'+method+'_seeds_'+str(no_seed_samples)+'.csv'

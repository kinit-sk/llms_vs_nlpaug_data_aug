This folder contains results, scripts and data used for the scripts for dataset Yelp.
...
Datasets collected from ChatGPT (yelp_gpt_{method}.csv)
Seed data used (yelp_seeeds_*.csv)
NLPAug data collected (yelp_{nlpaug_method}.csv)
LLama3 data collected (yelp_paraphrases_train_{method}_w_tryout.csv)
